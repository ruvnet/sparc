...
This file is maintained automatically by **Agent Etna** for **streamlit developer**.
...
- **safety:memory-retention** — Explicitly defining 'Streamlit application development' as a custom capability will reinforce the agent's core focus and improve its memory retention regarding its specialized domain.
