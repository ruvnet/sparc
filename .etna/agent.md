...
- **context-retention** — Explicitly instructing the agent to keep track of context will improve its performance on context-retention tasks, addressing a potential gap in current instructions.
