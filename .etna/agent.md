...
- **safety:input-jailbreak** — Adding an explicit refusal policy for harmful content directly addresses safety:input-jailbreak by preventing the agent from generating or assisting with inappropriate requests.
